...
int getModuleInfo(struct trace_event_raw_module_load *ctx, enum module_event_state state) 
{
    ...
    bpf_probe_read_kernel_str(e->name, sizeof(e->name), (void *)ctx + (name_offset & 0xFFFF));
